...
import agh.ics.opp.generators.*;
import agh.ics.opp.maps.IAnimalPositionCorrector;
import agh.ics.opp.maps.IMapObserversHandler;
import agh.ics.opp.maps.IWorldMap;
import agh.ics.opp.maps.UpdatableTreeSet;
...
public class MapUpdater implements IMapUpdater {
    ...
    public MapUpdater(IWorldMap map, SimulationSetup setup) {
        ...
        ((IMapObserversHandler) map).addPlantObserver((IPlantObserver) plantGenerator);
...
//                System.out.println("Nowe życie będzie na " + position);
