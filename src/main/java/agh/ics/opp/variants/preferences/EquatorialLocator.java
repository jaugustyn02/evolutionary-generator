...
public class EquatorialLocator implements IPlantPlacementLocator {
    ...
    private boolean equatorIsFull(){
        return true; // Trzeba wiedzieć ile jest niezajętych pól przez rośliny na równiku
    }

    // czy mapa jest cała zapełniona
    private boolean mapIsFull(){
        return false; // Trzeba wiedzieć ile jest niezajętych pól przez rośliny na całej mapie
    }
