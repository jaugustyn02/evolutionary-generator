package agh.ics.opp.simulation.maps.elements.animal.generators;

import agh.ics.opp.simulation.maps.elements.animal.genome.generators.GenomeGenerator;
import agh.ics.opp.simulation.maps.elements.animal.behaviours.ChaoticSelector;
import agh.ics.opp.simulation.maps.elements.animal.behaviours.IGeneSelector;
...
import agh.ics.opp.simulation.maps.IAnimalPositionCorrector;
import agh.ics.opp.simulation.maps.elements.animal.behaviours.OrderlySelector;
import agh.ics.opp.simulation.maps.elements.animal.genome.mutations.BoundedMutator;
import agh.ics.opp.simulation.maps.elements.animal.genome.mutations.IGenomeMutator;
import agh.ics.opp.simulation.maps.elements.animal.genome.mutations.UnboundedMutator;
